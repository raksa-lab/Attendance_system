...
app.get("/api/students_not_checkins", (req, res) => {
...
app.post("/api/students_not_checkins", (req, res) => {
  const {
    first_name,
    last_name,
    gender,
...
app.put("/api/students_not_checkins/:id", (req, res) => {
  const { id } = req.params;
  const {
    first_name,
    last_name,
...
app.delete("/api/students_not_checkins/:id", (req, res) => {
  const { id } = req.params;
  ...
  db.query(deleteQuery, [id], (err) => {
    ...
    // Reorder IDs query (multiple statements)
    const reorderQuery = `
      SET @count = 0;
...
// GET all check-ins
app.get("/api/students_checkins", (req, res) => {
...
app.post("/api/students_checkins", (req, res) => {
...
app.put("/api/students_checkins/:id", (req, res) => {
  const { id } = req.params;
  const { phone_number } = req.body;
...
app.delete("/api/students_checkins/:id", (req, res) => {
  const { id } = req.params;
