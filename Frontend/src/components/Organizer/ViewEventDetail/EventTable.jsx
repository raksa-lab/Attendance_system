...
//                 <tr key={`${event.id}-${event.name}`} className="hover:bg-gray-50">
            ...
            {currentEvents.length > 0 ? (
              currentEvents.map(event => (
                <tr key={`${event.id}-${event.name}`} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{event.dateStart}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{event.dateEnd}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{event.timeStart}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{event.timeEnd}</td>
