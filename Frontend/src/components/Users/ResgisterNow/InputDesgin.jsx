...
import organizer from "../../../assets/img/organizer.jpg"; //make it to real data 
...
export default function InputDesgin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("	http://localhost:3001/api/user/students_not_checkins", {
        method: "POST",
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="space-y-6">
                  ...
                  <div>
                    <label className="block text-gray-700 mb-2">Faculties</label>
                    <select
                      name="faculties"
                ...
                <div className="space-y-6">
                  <div>
                    <label className="block text-gray-700 mb-2">Phone Number (Tel)</label>
                    <input
                      type="tel"
                      name="phoneNumber"
